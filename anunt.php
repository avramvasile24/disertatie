...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header green-bg">
      ...
      <!--logo start-->
      <a href="dashboard.php" class="logo">MENIU <span class="lite"><?php echo $_SESSION['username']; ?></span></a>
      <!--logo end-->
    ...
    <?php
                ...
                echo "<div class='panel-noutati'>
                          <div class='noutati-heading'>NOUTATI</div>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  "Autor: <b style='color: #007afe;'>", $row['autor'], "</b></br>",
    ...
    <div class="row">
      ...
      <!--sidebar start--><?php
						  ...
						  $ok=0;
                          while ($row = mysqli_fetch_assoc($result) and $ok==0) {
                            if (($row['functie']=="ADMIN" OR $row['functie']=="PROFESOR" OR $row['functie']=="SECRETARIAT") and $row['username']==$username ){$ok=$ok+1; ECHO $ok;
                              echo ' 
                  ...
                  <div class="form">
                    ...
                    <form  action="anunturi.php" method="POST" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text"  id="autor" name="autor" value='; echo $_SESSION['name']; echo' >
                        </div>
                      </div>
      ...
      $(document).ready(function() {
        var calendar = $('#calendar').fullCalendar({
          ...
          select: function(start, end, allDay) {
            var title = prompt("Enter Event Title", start);
            var clasa = prompt("Introduceti clasa");
            var materie = prompt("Introduceti materie");
            if (title) {
