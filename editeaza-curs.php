...
<center><div class='buton-triforce'><a href='func4.php'><i class='fa fa-back'></i> REVENITI LA CURS</a></div>
  ...
  <div class="card-elevi">
    <div class="header-pagina" style="margin-bottom: 40px;"> EDITEAZA ACTIVITATI</div>
	    <form action="editeaza-continut.php" method="POST">
<input class="buton-adauga-note" type="text" name="materie" id="materie" value="<?php  echo $verificare;?>">
	    <input class="buton-adauga-note" type="text" name="clasa" id="clasa" value="<?php  echo $verificare1;?>">
      <div class="form-group">
        <label class="col-sm-3 control-label"><b>TIP:</b></label>
        <div class="col-sm-6">
          <select name="activitate" id="activitate">
              <option> Lectie </option>
			  <option> Tema </option>
          </select>
          <label class="col-sm-12 control-label"><b>Saptamana:</b></label>
      ...
      <center><input class="buton-triforce" type="submit" value="Continuati"></center>
    </form>
  </div>
    </div>
    <div class="row">
