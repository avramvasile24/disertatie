      ...
      <div id="frm" class="panel-parteneri">
        ...
        <div class="panel-body">
          <div class="table-responsive">
            ...
            <div class="titlu-parteneri"  style='color: #FF00FF; font-weight: bold;'>DOCUMENTELE MELE</div>

            <table class="table table-striped table-bordered table-hover">
              <thead>
                <tr><b>
                  <th  style='color: #FF00FF; font-weight: bold;'>USERNAME</th>
                  <th  style='color: #FF00FF; font-weight: bold;'>DOCUMENTE</th>
              ...
              <tbody>
                <?php
                $select_stmt = $db->prepare("SELECT * FROM documente WHERE 1");  //sql select query
                $select_stmt->execute();
                ...
                ?>
                      <tr>
                        ...
                        <td><embed src="upload/<?php echo $row['fisier']; ?>" height="200px" /></td>
                        <td><a href="edit.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">EDITEAZA</a></td>
            ...
            <center>
              <div class="buton-triforce" style="margin-bottom: 30px;"><a href="add.php"><i class="fa fa-plus"></i> ADAUGA DOCUMENTE</a></div>
            </center>
