...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header green-bg">
      ...
      <!--logo start-->
      <a href="dashboard.php" class="logo"><b>MENIU <span class="lite"><?php echo $ok;  ?></span></a></b>
      <!--logo end-->
  ...
  <<script src="js/fullcalendar.min.js">
    ...
    <div class="card-clase">
      ...
      <h3 style="margin-bottom: 40px; color: #FF00FF; font-weight: bold;">&nbsp; ADAUGA CLASE - <b><?php echo $unitate; ?></b></a></h3>
    </div>
    <div class=" col-lg-12">
        <div class="col-lg-12">
          <div class="panel-body">
            <div class="table-responsive">
              <form action="adaugaclasa.php" method="POST">
                <div class="form-group">
                  <label class="col-sm-3 control-label" style="margin-bottom: 40px; color: #FF00FF; font-weight: bold;"><b>ADAUGA CLASA:</b></label>
                  <div class="col-sm-6">
                    <input type="text" name="clasa" id="clasa"> 
					</div>
                  </div>
                </div>
            </div>
          ...
          <center><input class="buton-triforce" type="submit" style="margin-bottom: 40px; color: #FF00FF; font-weight: bold;" value="ADAUGA CLASA"></center>
        </div>
		</form>
		</div>
		</div>
...
<div class="card-clase">
      <div class="header-pagina">
      <h3 style="margin-bottom: 40px; color: #FF00FF; font-weight: bold;">&nbsp; STERGE CLASA - <b><?php echo $unitate; ?></b></a></h3>
    </div>
    ...
    <div class=" col-lg-12">
        <div class="col-lg-12">
          <div class="panel-body">
            <div class="table-responsive">
              <form action="stergereclasa.php" method="POST">
                <div class="form-group">
                  <label class="col-sm-3 control-label" style="margin-bottom: 40px; color: #FF00FF; font-weight: bold;"><b>STERGE CLASA:</b></label>
                  <div class="col-sm-6">
                    <input type="text" name="clasa" id="clasa" > </div>
                  </div>
                </div>
            </div>
          </div>

          <center><input class="buton-triforce" type="submit" style="margin-bottom: 40px; color: #FF00FF; font-weight: bold;" value="STERGE CLASA"></center>
        </div></form>
</body>
