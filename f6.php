...
<head>
  ...
  <title>Lista Cadre Didactice</title>
...
<body>
  ...
  <div class="card-elevi"><?php
	...
	?>
    <div class="header-pagina" style="margin-bottom: 40px;">LISTA CADRE DIDACTICE - <b> <?php echo $unitate; ?></b></a></div>
	<center><div class='buton-triforce'><a href='dashboard.php'><i class='fa fa-back'></i> REVINO LA PAGINA PRINCIPALA</a></div>
	<br><br></center>
	<br>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            ...
            $select_stmt = $db->prepare("SELECT * FROM users WHERE 1");  //sql select query
            $select_stmt->execute();
            while ($row = $select_stmt->fetch(PDO::FETCH_ASSOC)) {
              if ($row != 1 and $row['functie'] == "PROFESOR") { ?>

                <tr>
                  <td><?php echo $row["nume"]; ?></td>
                  <td><?php echo $row["diriginte"]; ?></td>
                </tr> <?php
                    }
                  }
                      ?>
  ...
  <div class="card-clase">
      ...
      <h3>&nbsp; STERGE PROFESOR - <b><?php echo $unitate; ?></b></a></h3>
    </div>
    ...
    <div class=" col-lg-12">
        <div class="col-lg-12">
            ...
            <div class="table-responsive">
              <form action="stergere.php" method="POST">
                <div class="form-group">
                  <label class="col-sm-3 control-label"><b>STERGE PROFESOR:</b></label>
                  <div class="col-sm-6">
                    <select  name="membru" id="membru" ><?php $sql1 = "SELECT * FROM users WHERE 1";
            $result1 = mysqli_query($conectare, $sql1);
            while ($row1 = mysqli_fetch_assoc($result1)) {
				if($row1['functie']=="PROFESOR"){
            
                ?> <option> <?php echo $row1['nume'];  ?></option>
			</div><?php }} ?></select>
                  </div>
                </div>
            </div>
          ...
          <center><input class="buton-triforce" type="submit" value="STERGE PROFESOR"></center>
        </div>
</body>
