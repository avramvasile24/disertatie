...
<body>
  ...
  <div class="card-elevi">
    <div class="header-pagina" style="margin-bottom: 40px; color: #FF00FF; font-weight: bold">Elevi</div>

    <form action="afiseazalista.php" method="POST">
      <div class="form-group">
        <label class="col-sm-3 control-label" style="margin-bottom: 40px; color: #FF00FF; font-weight: bold"><b>CLASA:</b></label>
        <div class="col-sm-6">
          <select name="clasa">
            ...
            $ok = 0;
            while ($row = mysqli_fetch_assoc($result)) {
if($clasa==$row['cys'] and $idUnitate=$row['idUnitate'])				?>
              <option><?php echo $clasa = $row['cys']; ?> </option>
            <?php } ?>
          </select>
</div>
</div>
<input class="buton-triforce" type="submit" style="margin-left: 40px;" value="AFISEAZA LISTA CU ELEVI"></center>
	          
      
    </form>
  </div>
  
<?php  if($fff==="ADMIN" or $fff==="SECRETARIAT"){ echo '
  <div class="card-clase">
      <div class="header-pagina">
      <h3 style="margin-bottom: 40px; color: #FF00FF; font-weight: bold">&nbsp; STERGE</a></h3>
    </div>
    ...
    <div class=" col-lg-12">
        <div class="col-lg-12">
          <div class="panel-body">
            <div class="table-responsive">
              <form action="stergere.php" method="POST">
                <div class="form-group">
                  <label class="col-sm-3 control-label" style="margin-bottom: 40px; color: #FF00FF; font-weight: bold"><b>STERGE ELEV:</b></label>
                  <div class="col-sm-6">
                    <select  name="membru" id="membru" ><?php $sql1 = "SELECT * FROM users WHERE $id="$idUnitate"";
            $result1 = mysqli_query($conectare, $sql1);
            while ($row1 = mysqli_fetch_assoc($result1)) {
				if($row1["functie"]=="ELEV"){
          ...
          <center><input class="buton-triforce" type="submit" style="color: #FF00FF;" value="STERGE ELEV"></center>
</div>'; }	?>
</body>
