...
<body>
  ...
  <div class="header-pagina" style="padding-top: 100px;">CATALOG - 	  <?php echo $clasa=$_POST['clasa'];echo ' '; echo $elev = $_POST['elev'];?></a></div>
<center><div class='buton-triforce'><a href='funct5.php'><i class='fa fa-back'></i> REVENITI LA NOTE</a></div>
  ...
  <div class="panel-adauga-note" style="margin-bottom: 30px;">
    <form action="finish_nota.php" method="POST">
      <div class="form-group">
		...
		<label class="col-sm-3 control-label"><b>Nota:</b></label>

          <input type="text" name="nota" id="nota">

		  		<label class="col-sm-3 control-label"><b>Data:</b></label>

          <input type="date" name="data" id="data">
		  		  		<label class="col-sm-3 control-label"><b>Absenta:</b></label>


          <input type="date" name="data1" id="data1">


          <input class="buton-adauga-note" type="submit" value="ADAUGA NOTA">
        </div>
      </div>
    </form>
  </div>
