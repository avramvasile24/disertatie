...
<body>
  ...
  <section id="container" class="">
    ...
    <form action="adauga-note.php" method="POST">
	
      <div class="form-group">
        <label class="col-sm-3 control-label label-clasa">Selecteaza CLASA:</label>
        <div class="col-sm-6">
          ...
          <input class="buton-adauga-note" type="submit" value="ADAUGA NOTE IN CATALOG">
