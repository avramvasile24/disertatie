 ...
 <br><br><br><br><br><div>
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  <div class="form-group">
						  	<label for="date">Unitate de invatamant</label>
							
								<textarea class="form-control select2" name="school" required>
								  <?php 
									$query2=mysqli_query($con,"select * from member order by school")or die(mysqli_error($con));
							...
							<label for="date">Teacher</label>
								...
								<select class="form-control select2" name="teacher" required>
								  <?php 
									$query2=mysqli_query($con,"select * from users order by functie")or die(mysqli_error($con));
									  while($row=mysqli_fetch_array($query2)){
										  if($row['functie']=="PROFESOR"){
								  ?>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
			  ...
			  <form class="form-horizontal" method="post" action="pages/faculty_sched.php" target="_blank">
              ...
              <div class="modal-footer">
				<button type="faculty_class_sched.php?id=<?php echo $member;?>" class="btn btn-primary">Print Class Schedule</a></td>" name="search" class="btn btn-primary">Display Schedule</button>
 ...
 <div id="searchclass" class="modal fade in" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              ...
              <div class="modal-body">
			  <form class="form-horizontal" method="post" action="pages/class_sched.php" target="_blank">
 ...
 <div id="searchroom" class="modal fade in" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              ...
              <div class="modal-body">
			  <form class="form-horizontal" method="post" action="pages/room_sched.php" target="_blank">
 ...
 <!--end of modal--> 
	<script type="text/javascript">
		...
		$(document).on('submit', '#reg-form', function()
		 {  
		  $.post('pages/submit.php', $(this).serialize(), function(data)
		  {
		   $(".result").html(data);  
		   $("#form1")[0].reset();
		  // $("#check").reset();
