...
<body>
 ...
 error_reporting(0);
  ...
  <div class="header-pagina" style="padding-top: 100px;">CATALOG - 	  <?php  echo $clasa=$_POST['clasa']; ?></a></div>
<center><div class='buton-triforce'><a href='funct5.php'><i class='fa fa-back'></i> REVINO LA NOTE</a></div>
  ...
  <div class="panel-adauga-note" style="margin-bottom: 30px;">
    <form action="adauga-note-1.php" method="POST">
         <input class="buton-adauga-note" type="text" name="clasa" id="clasa" value="<?php  echo $clasa;?>">

        <label class="col-sm-3 control-label label-clasa">Selecteaza ELEV:</label>
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
          ...
          <input class="buton-adauga-note" type="submit" value="CONTINUATI">
        </div>
      </div>
    </form>
  </div>
